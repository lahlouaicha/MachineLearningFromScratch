...
Original file is located at
    https://colab.research.google.com/drive/19CIEJpEtIa1Uxrxb0wqr7tqWtRypHBZb
"""
...
class KNN_Classifier(): 
    ...
    def predict(self, X_test):
      ...
      for row in range(nb_predictions):
        ...
        labels, labels_counts = np.unique(k_labels, return_counts=True) # count the labels            
        predictions[row] = labels[np.argmax(labels_counts)] # Choose majority class
